...
\autoref{fig:flux_data_nd280_2015like} shows the ND280 flux parameters for the two fits. 
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{ND280 flux parameters after the data fit for different run periods}
	\label{fig:flux_data_nd280_2015like}
\end{figure}
