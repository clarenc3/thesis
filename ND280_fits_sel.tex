...
\red{Put in 1Trk and Ntrk definitions}
...
The binning in \pmu \cosmu for each sample is shown below. The FHC selection largely share the same binning and has the highest number of bins. The total number of fit bins is 1624, of which 902 are FHC (six selections) and 722 are RHC (eight selections).
\begin{itemize}
