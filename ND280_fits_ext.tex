...
\begin{table}[h]
	\begin{tabular}{l | c c c}
		...
		\hline
	\end{tabular}
	\caption{Markov Chain parameters for the various Asimov fits in \autoref{sec:asimov_2018}}
...
The two ND280 covariance matrices are again compatible and produce the same values throughout the cross-section parameters.
\begin{figure}[h]
	\centering
	\begin{subfigure}[t]{0.49\textwidth}
...
As with the likelihood scan, we now compare results from using the new rebinned selections versus the selection and binning of 2017, but including the new run 7 and 8 data.

In the light of the biases from using the multi-$\pi$ samples above, this is p
\begin{figure}[h]
	\centering
	\begin{subfigure}[t]{0.10\textwidth}
...
\begin{figure}[h]
	\begin{subfigure}[t]{0.49\textwidth}
		\includegraphics[width=\textwidth, trim={0mm 0mm 0mm 0mm}, clip,page=11]{figures/mach3/2018/asimov/corr/2018a_MultiPi_Binningv6_NewCov_Asimov_merge_drawCorr}
	\end{subfigure}
	\begin{subfigure}[t]{0.49\textwidth}
...
\section{Data fit}
\subsection{Full and reduced ND280 cov}
\begin{figure}[h]
	\centering
	\begin{subfigure}[t]{0.10\textwidth}
	...
	\end{subfigure}
	\caption{ND280 flux parameters, fitting to data with different ND280 matrices}
\end{figure}
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{SK flux parameters, fitting to data with different ND280 matrices}
\end{figure}
