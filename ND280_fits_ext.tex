...
\begin{figure}[h]
	...
	\begin{subfigure}[t]{0.32\textwidth}
		...
		\caption{BeRPA D}
	\end{subfigure}
\caption{Asimov likelihood scans for multi-$\pi$ and rebinned samples versus the unchanged multi-track sample from 2017}
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{Asimov likelihood scans for multi-$\pi$ and rebinned samples versus the unchanged multi-track sample from 2017 for some pion FSI rescaterring parameters}
...
The MCMC parameter obtained for the different studies are shown in \autoref{tab:mcmc_asimov_2018}. The primary reason behind the low acceptance for the ``Full cov'' (full ND280 covariance matrix used) is the 4370 parameters being fit simultaneously.
\begin{table}[h]
	\begin{tabular}{l | c c c}
		\hline
		\hline
...
Simultaneous with checking the performance of the parameterisation, we compare a fit to Asimov data using the reduced ND280 covariance matrix with 1036\red{confirm} parameters and one using the full ND280 covariance matrix without any bin merging, leading to 4236 parameters \red{confirm this}.

\autoref{fig:asimov_fit_2018_full_red_beam_nd280} an \autoref{fig:asimov_fit_2018_full_red_beam_sk}
\begin{figure}[h]
	\centering
	...
	\end{subfigure}
	\caption{ND280 flux parameters, comparing Asimov fits with full and reduced ND280 covariance matrices}
	\label{fig:asimov_fit_2018_full_red_beam_nd280}
\end{figure}
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{SK flux parameters, comparing Asimov fits with full and reduced ND280 covariance matrices}
	\label{fig:asimov_fit_2018_full_red_beam_sk}
\end{figure}

\autoref{fig:asimov_fit_2018_full_red_xsec}
\begin{figure}[h]
	\centering
	\begin{subfigure}[t]{0.49\textwidth}
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{ND280 flux parameters, comparing Asimov fits with rebinned multi-$\pi$ to 2017 binned multi-track}
\end{figure}
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{SK flux parameters, comparing Asimov fits with rebinned multi-$\pi$ to 2017 binned multi-track}
\end{figure}
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{ND280 flux parameters, fitting to Asimov without varying detector parameters}
\end{figure}
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{SK flux parameters, fitting to Asimov without varying detector parameters}
\end{figure}
