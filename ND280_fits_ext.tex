...
The interaction systematics are similar to \autoref{subsec:syst_xsec} with two changes: a new FSI tune was developed with a more robust fitting method, carefully selected scattering data (including data from the dedicated DUET experiment\cite{duet}). It was also decided to remove the high energy charge exchange pion final state parameter.
...
\begin{table}
	\begin{tabular}{l c}
		...
		\hline
		FEFQE & $1.069\pm0.313$ \\
		FEFABS & $1.404\pm0.432$\\
		FEFCX & $0.697\pm0.305$\\
		FEFINEL & $1.002\pm1.101$\\
		FEFQEH & $1.824\pm0.859$ \\
		FEFCXH & $1.8\pm0.00$\\
		\hline
		\hline
	\end{tabular}
...
New thing is FSI central values and the CC norm nu nubar (radiative corrections)
...
\begin{table}
	\begin{tabular}{l | c c | c c | c c | c c}
		...
		\hline
	\end{tabular}
	\caption{Event rate uncertainties from the prior and posterior model broken down by sample}
